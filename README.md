...
The goal of this project was to demonstrate Python game logic, keyboard input and canvas drawing, as well as browser integration using PyScript (Added later).
